...
def main():
    ...
    parser.add_argument('--output', default='submission.csv', help='Output file for predictions (default: submission.csv)')
    parser.add_argument('--epochs', type=int, default=10, help='Number of training epochs (default: 10)')
    parser.add_argument('--batch-size', type=int, default=64, help='Batch size for training (default: 64)')
    parser.add_argument('--lr', type=float, default=0.01, help='Learning rate (default: 0.01)')
    parser.add_argument('--inputs', type=int, default=784, help='Hidden size (default: 784)')
    ...
    class SingleLayerNet(nn.Module):
        def __init__(self):
            ...
            self.linear = nn.Linear(args.inputs, 10)
